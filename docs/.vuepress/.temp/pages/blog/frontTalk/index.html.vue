...
<p>虽然自己的经验是不足以谈关于技术管理这一块的内容。但是觉得自己以后也会走上这一条路的，所以提前了解一下也不是不行，而且我觉得老师讲的是非常的好，能够引起我的思考。</p>
...
<h2 id="_02-成长路线" tabindex="-1"><a class="header-anchor" href="#_02-成长路线" aria-hidden="true">#</a> 02 成长路线</h2>
<p>我们知道任何事情都会有属于它的体系，就好像我们人生的成长路线一样，经过九年义务教育，初高中然后大学等，都会有一个成长的路线。</p>
...
<p>所以当你已经可以在上面的几点有自己的<code v-pre>理解和沉淀</code>，那么自然你就会有属于自己的标签，有属于自己的<code v-pre>竞争力</code>，满足了技术本身最基本的需求。</p>
<p><strong>扩大自己的影响力</strong></p>
<p><code v-pre>影响力很重要</code>，有时候给你带来的机会也是很多的。为什么这么说呢？因为你的圈子就在这了，当你能够在圈子里面小有名气的时候自然就会有人来主动认识你，不管是技术探讨还是工作交流乃至职位推荐都有。那么如何做呢？</p>
<ul>
<li>写博客</li>
<li>多逛社区</li>
<li>多与人交流</li>
...
<p>这也是自己当前做的事情，<code v-pre>把自己的想法分享出去</code>，正所谓你有一个想法我有一个想法，交换之后我们就有两个想法。其实很多时候<code v-pre>技术不是最重要的</code>，比如你开发一个非常厉害的软件或者项目，没有人使用和买单，那你的价值就不存在了。</p>
...
<h3 id="未来抉择" tabindex="-1"><a class="header-anchor" href="#未来抉择" aria-hidden="true">#</a> 未来抉择</h3>
<p>当你在技术的方面有不错的沉淀的时候，你就会觉得一切都游刃有余，这时候其实你就会进入了一个舒适区了，而且紧接着而来的就是迷茫期。</p>
...
<p><code v-pre>专家级别的任务其实不是他懂得了多少</code>，而是在这个<code v-pre>领域钻研的有多深</code>。所以关于某项技术的研究，如果你要进行深耕那么你就要做一些别人没有接触过的东西，研究一些别人没有做过的东西，拓宽知识盲区。</p>
<p><img src="https://imgkr.cn-bj.ufileos.com/6eb61ae7-efe5-4ba5-964c-1de4deed7b69.png" alt=""></p>
<p><strong>业务管理</strong></p>
<p>或者你已经疲倦了写代码的技术活，已经不想再去接触这份工作了。那么其实你大可以往管理的方向去靠，就好像你不会技术，但是你懂的如何<code v-pre>找技术的同学来帮你进行业务开发</code>。我觉得这是很多技术人都有这样的追求，认为写了几年的代码，没有什么意思。</p>
...
<p>我想说的其实就是纯管理的路线也有它自己的缺点。比如你会花更少的时间甚至不花时间在技术上面，你的想法也有可能<code v-pre>跟不上时代的发展</code>；你可能在跳槽之后发现来到了一个全新的领域，对业务不熟悉而且你基本上也忘记了技术的开发，这时候难免会有一些被抛弃的感觉。</p>
...
<p>这是一种<code v-pre>两者兼顾的职位</code>，可能你会觉得自己没有这么多时间去做技术，不放心别人去做。其实这也是很多Leader的烦恼，这里其实你做到用人不疑，疑人不用就好。只有你的小伙伴进不了你才会进步，给他们多一点的机会，团队才会有进步。</p>
<p><img src="https://imgkr.cn-bj.ufileos.com/af519c57-f3a4-4c1a-a7b8-9492107c3635.png" alt=""></p>
<h3 id="转型成功" tabindex="-1"><a class="header-anchor" href="#转型成功" aria-hidden="true">#</a> 转型成功</h3>
<p>虽说你是确定了自己的未来方向，但是你仍然需要一段<code v-pre>过渡期</code>来习惯你的身份、习惯你的工作。这一阶段其实会有很多干扰你的信息，你要学会如何去调整这些负面的、干扰的信息。</p>
<p><code v-pre>转型成功意味着你有更大的责任</code>，即使你的工作重心已经不再是代码层面的东西，但是你得会沟通，你会技术，你也懂业务，你看得到未来。这些东西其实是一个人的品质，看似很虚的东西，但是你不具备这样的品质与能力，你的转型也不是成功的。</p>
<p>虽说别人羡慕你的工作，但是你有时候也是力不从心，对于一些细节性的东西也无法准确把握。这些种种的不愉快也是只有你能够体会到，也就是我们说的心魔。竹隐老师说的一句话我很喜欢“<code v-pre>体力支撑你到P6，脑力支撑你到P7，心力支撑你到P8</code>”,这样是从侧面反映了技术其实不是最重要的。</p>
...
<p>我认为不论你是一个技术人员亦或是非技术人员，你都应该<code v-pre>懂得沟通的技巧</code>，有效的沟通可以节约大量的成本，也使得工作顺利。比如你要与产品进行对接，与下面的开发人员进行对接，任务的分配等等。<code v-pre>沟通与管理的软技能是至关重要的</code>，这也是你从技术转型之后你要具备的素质，严格来说你应该在做技术的时候已经可以有这些素质。</p>
...
<p>这里我们就要坚定自己的路线，做到拿得起放得下。<code v-pre>放下过去的一些想法，转变自己的思维</code>，通过在业务与技术之间找到平衡点，找到新的成就走下去。</p>
...
<p>通过看一场讲座真的拓宽了自己的很多想法，关于技术转型我们以后都会遇到的，不管你是从事技术方向还是管理方向都要做出自己的选择。即使你现在还是工作一年半年，你也要了解一下将来的方向，了解一下以后自己的方向应该是怎么走，早点规划自己的职业方向。</p>
<p>好了，今天的分享与思考就到这里，有兴趣的小伙伴们可以去搜索一下前端早早聊大会，我觉得是很不错的！上面有很多关于管理方面的思考与实践、还有一下关于团队建设等。</p>
<p>素材来源：</p>
<ul>
<li><a href="https://www.yuque.com/zaotalk/posts/s1ppt" target="_blank" rel="noopener noreferrer">前端早早聊大会第一期<ExternalLinkIcon/></a></li>
</ul>
</div></template>
