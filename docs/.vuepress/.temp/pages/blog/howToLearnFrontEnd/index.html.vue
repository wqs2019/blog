...
<p><img src="@source/blog/howToLearnFrontEnd/img/1.jpg" alt=" "></p>
<h2 id="_02-爬坡阶段" tabindex="-1"><a class="header-anchor" href="#_02-爬坡阶段" aria-hidden="true">#</a> 02 爬坡阶段</h2>
<h5 id="青铜阶段" tabindex="-1"><a class="header-anchor" href="#青铜阶段" aria-hidden="true">#</a> <strong>青铜阶段</strong></h5>
<p>我们从最基本的前端基础知识开始讲起，这里也是我们最初的出发点。在这个过程当中呢，你会觉得前端的世界是那么的小，做什么事情都是的得心应手的，一度沉浸在自己的世界里不能自拔。你自己想走出去，但是又害怕外面的世界，所以你可能会在这里徘徊一段时间，等你觉得自己可以有信心打怪升级的时候自然会攀越过去。</p>
...
<p><img src="@source/blog/howToLearnFrontEnd/img/5.jpg" alt=" "></p>
<p>这里可以推荐大家去看：</p>
<ul>
<li>菜鸟教程</li>
<li>w3c school</li>
...
<h5 id="白银阶段" tabindex="-1"><a class="header-anchor" href="#白银阶段" aria-hidden="true">#</a> <strong>白银阶段</strong></h5>
<p>在前一个阶段里面，你已经学会了如何去制作一个简单/复杂的静态网页，但是都是一些写死的内容。所以在这个阶段里面你就大可以学习动画的制作，有了JavaScript这门脚本语言，简直就是如虎添翼。我在个阶段的时候，很关心页面是怎么动起来的，只是用到一个定时器的函数，仅此而已。</p>
...
<h5 id="黄金阶段" tabindex="-1"><a class="header-anchor" href="#黄金阶段" aria-hidden="true">#</a> <strong>黄金阶段</strong></h5>
<p>当你掌握了前端的”三件套“，我们就应该可以做点东西出来了，是时候检验自己的学习成果的时候了。但是你先别急，在这个阶段里面有很多可以让你头疼的东西，根本的原因是——你前面两个阶段没有学好。</p>
...
<p><img src="@source/blog/howToLearnFrontEnd/img/6.jpg" alt=" "></p>
<p>这里推荐大家去看：</p>
<ul>
<li>框架的官网</li>
<li>vue.js实战（书）</li>
...
<h5 id="钻石阶段" tabindex="-1"><a class="header-anchor" href="#钻石阶段" aria-hidden="true">#</a> <strong>钻石阶段</strong></h5>
<p>当年很庆幸自己已经熬过去了，你以为人生终于走上了巅峰。但是你错了，你的前端人生才刚刚开始，前面所做的各种事情只不过是为了现在能够正式开始而已。这也是为什么很多小伙伴都会觉得前端的水很深，以至于后面越学越怀疑人生，不懂为什么要这样对自己，直接告诉我前端水深就好了不行吗？但是我想说的是，既然路是自己选的，那么就开心地走下去，你会感激的。</p>
...
<p><img src="@source/blog/howToLearnFrontEnd/img/4.jpg" alt=" "></p>
<p>这里推荐大家去看：</p>
<ul>
<li>深入浅出webpack（书）</li>
<li>前段工程化（书）</li>
...
<p><img src="@source/blog/howToLearnFrontEnd/img/2.jpg" alt=" "></p>
<h5 id="王者阶段" tabindex="-1"><a class="header-anchor" href="#王者阶段" aria-hidden="true">#</a> <strong>王者阶段</strong></h5>
<p>一般来说，当你到达这个阶段的时候，人生就可以熬出头了，如无意外你将可以独立带领一个小团队开发产品，负责某一个生产线的项目，也就是leader级别的人物了，而且很多面试都是你来负责的。</p>
<p>但是这个阶段只有很少一部分人可以到达，有人可能到了上一个阶段就放弃了转而继承家产也不一定。由于没有到达这个阶段，我也不知道该怎么去说，也不知道推荐什么。当我有能力的时候，在来与大家详谈吧，话题保留。</p>
<p><img src="@source/blog/howToLearnFrontEnd/img/3.jpg" alt=" "></p>
<h2 id="_03-面试基础" tabindex="-1"><a class="header-anchor" href="#_03-面试基础" aria-hidden="true">#</a> 03 面试基础</h2>
...
<p><img src="@source/blog/howToLearnFrontEnd/img/7.jpg" alt=" "></p>
